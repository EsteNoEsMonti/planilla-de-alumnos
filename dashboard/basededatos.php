...
<div class="container">
    <h1>Instituto San Martin: Base de Datos</h1>
...
$consulta = "SELECT id, nombre, apellido, fnac, curso , tp1 , tp2 , nf FROM personas WHERE curso = 'Base de Datos' AND usuario_id = '$ID'";
