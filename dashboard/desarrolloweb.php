...
<div class="container">
  <h1>Instituto San Martin: Desarrollo Web</h1>
  ...
  $consulta = "SELECT id, nombre, apellido, fnac, curso , tp1 , tp2 , nf FROM personas WHERE curso = 'Desarrollo Web' AND usuario_id = '$ID'";
